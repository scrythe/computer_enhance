...
pub fn main(init: std.process.Init) !void {
    ...
    const listing_paths = [_][]const u8{ "..", "computer_enhance", "perfaware", "part1", "listing_0049_conditional_jumps" };
    ...
    const listing_expected_output_paths = [_][]const u8{ "..", "computer_enhance", "perfaware", "part1", "listing_0049_conditional_jumps.txt" };
...
fn execute_instructions(listing_output_writer: *std.Io.Writer, registers: *[14]u16, ip_reg: *u16, flags: *[FlagsMap.len]bool, listing_content: []u8) !void {
    try listing_output_writer.print("--- test\\listing_0049_conditional_jumps execution ---\r\n", .{});
    ...
    while (ip_reg.* < listing_content.len) {
        ...
        var prev_dest_reg_word_data: u16 = undefined;
